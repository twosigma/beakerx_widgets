...
class TestSparkUIProfile(unittest.TestCase):
    MOCK_TEST_JSON = str(
        pathlib.Path(__file__).parent.absolute()) + os.path.sep + "resources" + os.path.sep + "beakerxMock2.json"
    MOCK_JSON = str(
        pathlib.Path(__file__).parent.absolute()) + os.path.sep + "resources" + os.path.sep + "beakerxMock.json"
