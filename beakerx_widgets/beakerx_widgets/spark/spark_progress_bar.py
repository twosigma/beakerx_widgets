...
from beakerx_base import BeakerxBox, BaseObject, BeakerxHBox
from beakerx_widgets.spark.button_widget import RESTButton
...
class SparkStateGroupPanel(BeakerxHBox):
